FROM zabbix/zabbix-server-mysql:alpine-6.0.25
...
RUN set -x \
  ...
  && cd $tempDir \
  && wget https://download.microsoft.com/download/3/5/5/355d7943-a338-41a7-858d-53b259ea33f5/msodbcsql18_18.3.1.1-1_amd64.apk \
